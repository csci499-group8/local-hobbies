...
public record RecurringAvailabilityCreationRequest(
    ...
    @NotNullIfPresent DayOfWeek startDayOfWeek, //omitted if startDayOfMonth is submitted
    @NotNullIfPresent @Min(1) @Max(31) Integer startDayOfMonth, //omitted if startDayOfWeek is submitted
