CREATE TABLE users (
                       ...
                       show_age              BOOL                   NOT NULL DEFAULT FALSE, --make not default?
                       show_gender_displayed BOOL                   NOT NULL DEFAULT FALSE --make not default?
);
...
CREATE TABLE global_hobby (
                              ...
                              category TEXT NOT NULL CHECK (category IN ('Arts and Crafts',
                                                                         'Cooking',
                                                                         'Education',
                                                                         'Fitness',
                                                                         'Games',
...
COMMENT ON COLUMN time_zone_id IS 'IANA time zone ID';
...
CREATE TABLE availability_exception (
                                        ...
                                        override_duration   		INTERVAL                NOT NULL CHECK (duration > INTERVAL '0' AND duration < INTERVAL '1 week'),
